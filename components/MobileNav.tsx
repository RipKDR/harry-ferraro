...
export function MobileNav() {
  ...
  return (
    <nav
      ...
      className="mobile-nav fixed bottom-0 left-0 right-0 z-[400] border-t border-[#1e1c24]"
      style={{ background: 'rgba(7,6,10,0.97)', backdropFilter: 'blur(24px) saturate(1.5)', paddingBottom: 'max(8px, env(safe-area-inset-bottom))' }}
    >
        ...
        {BOT_LINKS.map(({ label, href, icon }) => {
          ...
          return (
            <Link
              ...
              style={{ color: active ? '#c8570a' : '#45424f' }}
            >
